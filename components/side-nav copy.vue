<template>
    <div :class="['cb--side-nav', activeClass]" :level="level">
        <div :ref="box" class="nav-box" :style="{ '--level': level }">
            <slot name="label-top" :active="active" :level="level" />
            <a
                class="nav-link"
                :href="to"
                nav-level
            ...
            <slot name="label-bottom" :active="active" :level="level" />
        </div>
        <div
            :class="['nav-items', isToggle]"
            :level="level"
